...
class StatusOrdersController extends Controller
{
    ...
    {
        return view('master.status-orders.index');
    }

    public function datatable(Request $request)
    {
        $api_url = config('api.api_url')."/status-orders";
    ...
    {
        $api_url = config('api.api_url')."/status-orders/".$id;
        $response = GuzzleHelper::get($request, $api_url);
    ...
    {
        $api_url = config('api.api_url')."/status-orders/".$request->id;
