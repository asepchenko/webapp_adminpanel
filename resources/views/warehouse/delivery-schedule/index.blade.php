...
<div class="content content-fixed bd-b">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">List Jadwal Pengiriman</h4>
          </div>
          <!--<div class="mg-t-20 mg-sm-t-0">
            <a href="{{ url('warehouse/trip/create') }}" class="btn btn-sm btn-brand-02"><i class="fas fa-plus"></i> Pengiriman Baru</a>
          </div>-->
        </div>
      </div><!-- container -->
    </div><!-- content -->
      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="row">
            ...
            <div class="d-flex align-items-center justify-content-between mg-b-20">
              <h6 class="tx-uppercase tx-semibold mg-b-0">Pengiriman Hari Ini</h6>
            </div>
    ...
    @include('warehouse.delivery-schedule.modal')
...
$(function(){
    ...
    $('#calendar').fullCalendar({
        ...
        eventClick:  function(event) {
            $('#modalBody').html('No Manifest : '+event.no+'<br> Driver : '+event.driver+ ' ['+event.truck_type+' - '+event.truck+ ' ]<br> Tujuan : '+event.destination+'<br> List STT : '+event.description);
