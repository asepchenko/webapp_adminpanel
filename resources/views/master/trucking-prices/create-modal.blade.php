		...
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
      		...
      		<div class="modal-body">
                ...
                <div class="row mt-2">
                  <label for="truck_type_id" class="col-sm-4 col-form-label">Tipe Truck *</label>
                  <div class="col-sm-8">
                      <select name="truck_type_id" id="truck_type_id" class="form-control form-control-sm" style="width: 100%;" required>
                          <option value="">- Pilih -</option>
