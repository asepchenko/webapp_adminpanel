...
<div class="content content-fixed bd-b">
    ...
    @include('master.banks.create-modal')
    @include('master.banks.delete-modal')
...
$(function(){
  ...
  $('#table_data').DataTable({
    ...
    //serverSide: true,
    ajax: {
      url: '{{ url("master/banks/datatable") }}',
      type: 'GET',
    },
    columns: [
  ...
  $("#frm-add").submit(function (e) {
    e.preventDefault();
    if($('#action').val() == "add"){
      var action = "{{ route('banks.store') }}";
    }else{
      var action = "{{ route('banks.update') }}";
    }
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        window.location.href = "{{ url('master/banks') }}";
      },
