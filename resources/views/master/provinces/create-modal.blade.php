		...
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
      		...
      		<div class="modal-body">
                ...
                <div class="row mt-2">
                    <label for="province_name" class="col-sm-4 col-form-label">Nama Provinsi *</label>
                      <div class="col-sm-8">
                        <input type="text" id="province_name" name="province_name" class="form-control form-control-sm" autocomplete="off" >
                      </div>
                </div>
              	<br />
