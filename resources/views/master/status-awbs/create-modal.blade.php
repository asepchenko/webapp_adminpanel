		...
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
      		...
      		<div class="modal-body">
                ...
                <div class="row mt-2">
                    <label for="status_name" class="col-sm-4 col-form-label">Nama Status *</label>
                      <div class="col-sm-8">
                        <input type="text" id="status_name" name="status_name" class="form-control form-control-sm" autocomplete="off" required>
                      </div>
                </div>
              	<br />
