...
<div class="content content-fixed bd-b">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">Tambah Customer</h4>
          </div>
        </div>
      </div><!-- container -->
    </div><!-- content -->
    ...
    <div class="content">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="row">
        <div class="col-lg-12">
        <form method="post" action="{{ route('customers.store') }}" enctype="multipart/form-data" id="frm-add">
            @csrf
            <input type="hidden" id="tax" name="tax" value="">
            <div class="row">
                <label for="customer_name" class="col-sm-2 col-form-label">Nama Customer *</label>
                <div class="col-sm-4">
                  <input type="text" id="customer_name" name="customer_name" class="form-control form-control-sm" autocomplete="off" required >
                </div>
            </div>
            <div class="row mt-2">
           ...
           -->
            ...
            <div class="mt-4">
                <span class="float-md-right">
                    <a href="{{ url('master/customers') }}" class="btn btn-sm btn-danger" type="button"><i class="fas fa-arrow-left"></i> Batal</a>
  ...
  $("#frm-add").submit(function (e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            window.location.href = "{{ url('master/customers') }}";
        },
