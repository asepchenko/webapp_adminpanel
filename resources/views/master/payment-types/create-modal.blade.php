		...
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
      		...
      		<div class="modal-body">
                ...
                <div class="row mt-2">
                    <label for="payment_name" class="col-sm-4 col-form-label">Nama Pembayaran *</label>
                      <div class="col-sm-8">
                        <input type="text" id="payment_name" name="payment_name" class="form-control form-control-sm" autocomplete="off" >
                      </div>
                </div>
				        <!--<div class="row mt-2">
                    <label for="termin_month" class="col-sm-4 col-form-label">Termin (Bulan)</label>
                      <div class="col-sm-8">
                        <input type="number" id="termin_month" name="termin_month" class="form-control form-control-sm" autocomplete="off" >
                      </div>
                </div>-->
              	<br />
