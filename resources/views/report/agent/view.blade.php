      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">Laporan Performa Agent - Oktober 2021</h4>
          </div>
        </div>
      </div><!-- container -->
    </div><!-- content -->
          ...
          <table id="table_data" class="table table-striped table-bordered" width="100%">
            <thead class="thead-primary">
                <tr>
                    ...
                    <th class="wd-20p">Order Selesai</th>
                    <th class="wd-20p">Order Terlambat</th>
                    <th class="wd-20p" style="text-align:center">Skor</th>
                </tr>
            </thead>
            <tbody>
                <tr>
