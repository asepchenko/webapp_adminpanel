      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">Laporan Order</h4>
          </div>
        </div>
      </div><!-- container -->
    </div><!-- content -->
      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        ...
        <div class="col-lg-12">
            <form>
                ...
                <div class="row mt-2">
                    <label for="tujuan" class="col-sm-2 col-form-label">Grouping By</label>
                    <div class="col-sm-4">
                        <select class="form-control">
                            <option label="- Pilih -"></option>
                            <option value="Firefox">Customer</option>
                            <option value="Safari">Agent</option>
                            <option value="Opera">Periode</option>
                        </select>
                    </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control">
                            <option label="- Pilih -"></option>
                            <option value="Firefox">OPEN</option>
                            <option value="Safari">ON DELIVERY</option>
                            <option value="Opera">DELIVERED</option>
                            <option value="Opera">HOLD</option>
                            <option value="Opera">CANCEL</option>
                            <option value="Opera">ALL</option>
                        </select>
                    </div>
                </div>
            </form>
            <div class="mt-4">
                <span class="float-md-right">
                    <a href="{{ url('report/order/view') }}" class="btn btn-sm btn-brand-02" type="button"><i class="fas fa-arrow-right"></i> Tampilkan</a>
