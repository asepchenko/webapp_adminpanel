		...
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
      		...
      		<div class="modal-body">
                ...
                <div class="row mt-2">
                    <label for="departemen_code" class="col-sm-4 col-form-label">Kode Departemen *</label>
                      <div class="col-sm-8">
                        <input type="text" id="departemen_code" name="departemen_code" class="form-control form-control-sm" autocomplete="off" >
                      </div>
                </div>
                <div class="row mt-2">
                    <label for="departemen_name" class="col-sm-4 col-form-label">Nama Departemen *</label>
                      <div class="col-sm-8">
                        <input type="text" id="departemen_name" name="departemen_name" class="form-control form-control-sm" autocomplete="off" >
                      </div>
                </div>
              	<br />
