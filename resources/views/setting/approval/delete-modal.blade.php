      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content tx-14">
          ...
          <div class="modal-body">
                <form method="POST" id="frm_del" action="{{ route('projects.delete') }}">
                    {{ csrf_field() }}
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-brand-02 tx-13" id="frm_del_submit">Delete</button>
            <button type="button" class="btn btn-brand-02 tx-13" id="frm_del_submit_wait" disabled
              style="display: none;"><i class="fa fa-spin fa-spinner"></i> <i>Deleting</i></button>
          </div>
          </form>
        </div>
      </div>
