...
<div class="content content-fixed bd-b">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">List Approval</h4>
          </div>
      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        ...
        <div data-label="Example" class="df-example demo-table">
          <table id="table_data" class="table">
            <thead>
                <tr>
                    <th class="wd-20p">Jenis</th>
                    <th class="wd-20p">Dept</th>
                    <th class="wd-20p">Next Dept</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Dept B</td>
                    <td>
                      <span class="badge badge-pill badge-secondary"><b>Aktif</b></span>
                    </td>
                    <td>Yudha</td>
                    <td>
                        ...
                        <a class="dropdown-item has-icon" href="#"><i class="fa fa-edit"></i> Ubah</a>
                ...
                <tr>
                    ...
                    <td>Dept C</td>
                    <td>
                      <span class="badge badge-pill badge-danger"><b>Tidak Aktif</b></span>
                    </td>
                    <td>Yudha</td>
                    <td>
                        <div class="dropdown d-inline">
    ...
    @include('setting.approval.create-modal')
    @include('setting.approval.delete-modal')
