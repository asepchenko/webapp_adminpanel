...
<div class="content content-fixed bd-b">
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">List Artikel</h4>
          </div>
          <div class="mg-t-20 mg-sm-t-0">
            <a href="{{ url('marketing/compro-post/create') }}" class="btn btn-sm btn-brand-02"><i class="fas fa-plus"></i> Tambah</a>
          </div>
        </div>
      </div><!-- container -->
    </div><!-- content -->
      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        ...
        <div data-label="Example" class="df-example demo-table">
          <table id="table_data" class="table">
            <thead>
                <tr>
                    <th class="wd-15p">Tgl Publish</th>
                    <th class="wd-15p">Title</th>
                    <th class="wd-20p">Slug</th>
                    <th class="wd-20p">Gambar</th>
    ...
    @include('marketing.compro.post.delete-modal')
...
<script>
 ...
 function editData(data){
    window.location.href = '{{ url("marketing/compro-post") }}'+'/'+data;
 }
$(function(){
  'use strict'
  ...
  $('#table_data').DataTable({
    ...
    serverSide: true,
    ajax: {
      url: '{{ url("marketing/compro-post/datatable") }}',
      type: 'GET',
    },
    columns: [
