...
<div class="content content-fixed bd-b">
          ...
          <div>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                ...
                <li class="breadcrumb-item active" aria-current="page">Banner Utama</li>
              </ol>
            </nav>
            <h4 class="mg-b-0">List Banner Utama</h4>
          </div>
          <div class="mg-t-20 mg-sm-t-0">
            <!--<button class="btn btn-sm btn-brand-02" type="button" id="btn-add-new"><i class="fas fa-plus"></i> Tambah</button>-->
            <a href="{{ url('marketing/compro-main-banner/create') }}" class="btn btn-sm btn-brand-02"><i class="fas fa-plus"></i> Tambah</a>
          </div>
        </div>
      </div><!-- container -->
    </div><!-- content -->
    ...
    @include('marketing.compro.main-banner.delete-modal')
...
<script>
 ...
 function editData(data){
    window.location.href = "{{ url('marketing/compro-main-banner') }}/"+data;
  }
$(function(){
  'use strict'
  ...
  $('#table_data').DataTable({
    ...
    serverSide: true,
    ajax: {
      url: '{{ url("marketing/compro-main-banner/datatable") }}',
      type: 'GET',
    },
    columns: [
