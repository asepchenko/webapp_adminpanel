      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <h4 class="mg-b-0">Ubah Banner</h4>
          </div>
        </div>
      </div><!-- container -->
    </div><!-- content -->
      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        ...
        <form method="post" action="#" enctype="multipart/form-data" id="frm-add">
            ...
            <div class="row">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control form-control-sm" id="caption" name="caption" value="{{ $banner->caption }}">
                	</div>
                </div>
				<div class="row mt-2">
                    <label for="start_date" class="col-sm-4 col-form-label">Tgl Mulai *</label>
					<div class="col-sm-8">
						<input type="date" class="form-control form-control-sm datetimepicker-input" id="start_date" name="start_date" autocomplete="off" value="{{ $banner->start_date }}">
                	</div>
                </div>
            <div class="row mt-2">
                        <label for="end_date" class="col-sm-4 col-form-label">Tgl Akhir *</label>
              <div class="col-sm-8">
                <input type="date" class="form-control form-control-sm datetimepicker-input" id="end_date" name="end_date" autocomplete="off" value="{{ $banner->end_date }}">
                      </div>
                    </div>
				        <div class="row mt-2">
